...
import (
	...
	horizonevertrustiov1beta1 "github.com/evertrust/horizon-issuer/api/v1beta1"
	"github.com/evertrust/horizon-issuer/internal/controller"
...
func init() {
	...
	utilruntime.Must(horizonevertrustiov1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7a72a7bd.horizon.evertrust.io",
	...
	if err := (&controller.IssuerReconciler{
		...
		Recorder:                 mgr.GetEventRecorderFor("horizon-issuer"),
