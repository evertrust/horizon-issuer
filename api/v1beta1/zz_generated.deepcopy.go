...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IssuerDnsChecker) DeepCopyInto(out *IssuerDnsChecker) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IssuerDnsChecker.
func (in *IssuerDnsChecker) DeepCopy() *IssuerDnsChecker {
	if in == nil {
		return nil
	}
	out := new(IssuerDnsChecker)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IssuerServiceAccount) DeepCopyInto(out *IssuerServiceAccount) {
	*out = *in
	in.ServiceAccountRef.DeepCopyInto(&out.ServiceAccountRef)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IssuerServiceAccount.
func (in *IssuerServiceAccount) DeepCopy() *IssuerServiceAccount {
	if in == nil {
		return nil
	}
	out := new(IssuerServiceAccount)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IssuerSpec) DeepCopyInto(out *IssuerSpec) {
	*out = *in
	...
	if in.DefaultTemplate != nil {
		...
		*out = new(IssuerTemplate)
		(*in).DeepCopyInto(*out)
	}
	if in.OverrideTemplate != nil {
		in, out := &in.OverrideTemplate, &out.OverrideTemplate
		*out = new(IssuerTemplate)
		(*in).DeepCopyInto(*out)
	}
	if in.DnsChecker != nil {
		in, out := &in.DnsChecker, &out.DnsChecker
		*out = new(IssuerDnsChecker)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IssuerTemplate) DeepCopyInto(out *IssuerTemplate) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IssuerTemplate.
func (in *IssuerTemplate) DeepCopy() *IssuerTemplate {
	if in == nil {
		return nil
	}
	out := new(IssuerTemplate)
